// DOM элементы (будут null на страницах, где их нет — это нормально)
...
// === Страница: index.html (авторизация в шапке) ===
  ...
  function updateAuthUI() {
    ...
    if (user) {
      ...
      authButton.onclick = () => {
        ...
        updateAuthUI();
        // На главной — скрыть кнопки после выхода
